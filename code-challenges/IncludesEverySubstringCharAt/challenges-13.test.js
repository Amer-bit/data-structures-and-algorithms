...
const findHappiness = (arr) => {
  // Solution code here...
  let happyFace = arr.filter((value) => {
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  let validation = /\W/g;
  let filterdNumber = arr.map((value) => {
...
const findAnything = (arr, target) => {
  // Solution code here...
  let targetString = arr.filter((value) => {
...
const findEvery = (arr, target) => {
  // Solution code here...
  let containTarget = arr.every((value) => {
    return value.includes(target);
  });
...
const unenrollBrook = (arr) => {
  // Solution code here...  
  let arr2 = arr.map((ovalue) => {
    let arr3 = ovalue.filter( ivalue => {
        return !(ivalue.includes('Brook'))
    })
    return arr3;
  });
  return arr2;
