...
const charCode = (arr) => {
  // Solution code here...
  let character = arr.map(value => {
    let charValue = value.charCodeAt(0)
    return charValue;
  })
  return character
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let abilitieName = arr.map(value => {
    let searchAbilityName = value.ability.name;
    return searchAbilityName;
  })
  return abilitieName;
};
